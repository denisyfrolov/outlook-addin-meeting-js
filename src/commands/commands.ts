...
import { commandsLocalizedStrings } from "./commandsLocalizedStrings";
import { sprintf } from "sprintf-js";
// eslint-disable-next-line no-unused-vars
import {
  ApplicationInsightsLogger,
  ApplicationInsightsLoggerConfig,
  LogstashLogger,
  LogstashLoggerConfig
} from "../logger/Logger";
...
Office.onReady(() => {
  ...
  UILocalizedText = commandsLocalizedStrings.getLocaleStrings(displayLanguage);
  LoggingLocalizedText = commandsLocalizedStrings.getLocaleStrings();
  contentLocalizedText = commandsLocalizedStrings.getLocaleStrings(contentLanguage);
 ...
 */
function insertMeeting(event: Office.AddinCommands.Event): void {
...
function processApiRequest(
  ...
  axios
    ...
    .then(function(apiResponse) {
      ...
      processApiResponse(apiResponse.data["url"], apiResponse.data["text"], event);
    })
